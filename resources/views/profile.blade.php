@foreach ($users as $user)
    ...
    <body class="min-h-screen gradient-bg flex items-center justify-center p-4 bg-gradient-to-r from-blue-200 to-blue-400">
        ...
        <div class="profile-card max-w-xl w-full text-black relative overflow-visible">
            ...
            <div class="px-6 pb-6 -mt-24"> <!-- Negative margin to create overlap -->
                <!-- Profile header -->
                <div class="flex flex-col mb-6">
                    ...
                    <p class="text-sm text-gray-600 mt-1">{{ $user->username }} •                         @if ($user->roles->isNotEmpty())
                ...
                <div class="">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium">{{ $user->identity_number ? $user->identity_number : 'N/A'}}</p>
                        </div>
                        <div>
