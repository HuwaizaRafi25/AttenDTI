    ...
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full overflow-hidden">
        ...
        <div class="p-4">
            <div class="flex items-center justify-center space-x-2">
                <img id="imageDelete" src="{{ asset('assets/images/logoti.png') }}" alt="Foto Profil" class="w-10 h-10 rounded-full bg-gray-100 p-1 object-cover">
                <div>
                    <p id="nameDelete" class="font-medium text-gray-900"></p>
                </div>
            </div>
            <p class="mt-4 text-sm text-gray-600">
                Anda yakin ingin menghapus outlet ini? Tindakan ini tidak dapat dibatalkan.
            </p>
        </div>
