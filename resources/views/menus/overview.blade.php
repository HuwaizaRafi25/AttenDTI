    ...
    <div class="lg:flex lg:flex-row gap-6 {{ Auth::user()->hasRole('admin') ? 'px-6' : 'p-6' }}  min-h-screen">
                                ...
                                @forelse ($recentActivities as $activity)
                                    <li class="flex items-start space-x-3 py-2 border-b border-gray-100">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <span
                                                class="text-xs text-gray-500">{{ $activity->created_at->format('H:i A') }}</span>
                                        </div>
                                    </li>
                                @empty
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 w-1/2 h-auto">
                        ...
                        <div class="mt-6">
                            <div class="w-full bg-gray-200 rounded-full h-2.5">
                                ...
                                @endphp
                                <div class="bg-green-600 h-2.5 rounded-full" style="width: {{ $activePercentage }}%">
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-blue-50 p-4 rounded-xl">
                                ...
                                <p class="text-2xl font-bold text-gray-800">Rp
                                    {{ number_format($totalDuesThisMonth, 0, ',', '.') }}</p>
                            ...
                            <div class="bg-red-50 p-4 rounded-xl">
                                ...
                                <p class="text-2xl font-bold text-gray-800">{{ $unpaidMonths }}</p>
        ...
        @else
            <div class="bg-white lg:w-3/4 md:w-full rounded-lg shadow-lg p-6 mb-6 lg:mb-0">
                ...
                {{-- jika hari libur atau sabtu minggu, maka tampilkan pesan --}}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                        <div
                            ...
                            <p class="text-xl font-semibold text-blue-900">
                                {{ Auth::User()->attendances()->where('check_in', '!=', null)->first()->check_in->format('H:i') ?? 'Belum Absen' }}
                            </p>
                        </div>
                        <div
                        ...
                        <div
                            ...
                            <p class="text-xl font-semibold text-blue-900">
                                {{ Auth::User()->attendances()->where('check_in', '!=', null)->count() }} Hari</p>
                        </div>
                    </div>
                @endif
                <div>
                    <h3 class="text-xl font-semibold text-blue-800 mb-4">History</h3>
                    @foreach (Auth::User()->attendances()->where('check_in', '!=', null)->orderBy('created_at', 'desc')->limit(5)->get() as $attendance)
                        <div class="bg-gradient-to-r from-green-100 to-blue-100 rounded-lg p-4 mb-4">
                            <div class="flex flex-wrap items-center justify-between">
                                <div
                                    ...
                                    <p class="text-sm font-semibold text-blue-600">
                                        {{ $attendance->check_in->format('d M') }}</p>
                                </div>
                                <div class="flex flex-col items-center mb-2 md:mb-0">
                                    <p class="text-sm text-blue-600">Masuk</p>
                                    <p class="font-semibold text-blue-800">{{ $attendance->check_in->format('H:i') }}</p>
                                </div>
                                <div class="flex flex-col items-center mb-2 md:mb-0">
                            ...
                            <div class="flex justify-center mt-2">
                                <div class="text-sm ml-12 text-blue-600">{{ $attendance->location->name }}</div>
                            </div>
                        </div>
                    @endforeach
                </div>
