...
<body class="bg-gray-50 min-h-screen p-4 md:p-8">
    <div id="form-container" class="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-6 md:p-8">
        ...
        <form class="space-y-12">
            <section>
                ...
                <div class="space-y-4">
                    <div class="grid gap-4 md:grid-cols-[1fr,auto,1fr] items-center">
                        <label class="text-sm font-medium text-gray-700">Desktop PC / Laptop</label>
                    ...
                    <div class="grid gap-4 md:grid-cols-[1fr,auto,1fr] items-center">
                        ...
                        <div class="flex space-x-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="storage" value="Y" class="form-radio text-blue-600">
                                <span class="ml-2">Ya</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="storage" value="T" class="form-radio text-blue-600">
                                <span class="ml-2">Tidak</span>
                            </label>
                        </div>
                        <input type="text" placeholder="Keterangan"
                    ...
                    <div class="grid gap-4 md:grid-cols-[1fr,auto,1fr] items-center">
                        ...
                        <div class="flex space-x-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="vehicle" value="Y" class="form-radio text-blue-600">
                                <span class="ml-2">Ya</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="vehicle" value="T" class="form-radio text-blue-600">
                                <span class="ml-2">Tidak</span>
                            </label>
                        </div>
                        <input type="text" placeholder="Keterangan"
                    ...
                    <div class="grid gap-4 md:grid-cols-[1fr,auto,1fr] items-center">
                        ...
                        <div class="flex space-x-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="handphone" value="Y" class="form-radio text-blue-600">
                                <span class="ml-2">Ya</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="handphone" value="T" class="form-radio text-blue-600">
                                <span class="ml-2">Tidak</span>
                            </label>
                        </div>
                        <input type="text" placeholder="Keterangan"
                    ...
                    <div class="grid gap-4 md:grid-cols-[1fr,auto,1fr] items-center">
                        ...
                        <div class="flex space-x-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="atk" value="Y" class="form-radio text-blue-600">
                                <span class="ml-2">Ya</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="atk" value="T" class="form-radio text-blue-600">
                                <span class="ml-2">Tidak</span>
                            </label>
                        </div>
                        <input type="text" placeholder="Keterangan"
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-700 border-b pb-2 mb-4">Tugas & Tanggung Jawab Kerja</h2>
                <div class="space-y-4">
                    <div class="grid gap-4 md:grid-cols-[1fr,auto,1fr] items-center">
                ...
                <div id="laporanTransaksi"
                    ...
                    <div class="p-8" id="laporanContainer">
                        <div class="mt-2 text-sm">
                            ...
                            <p class="mb-2">Saya yang bertandatangan dibawah ini, menyatakan penyelesaian kewajiban
                                yang
                                berhubungan
                                dengan pekerjaan dan akan segera diselesaikan selambat-lambatnya 1 hari kerja sebelum
                                hari terakhir
                                bekerja.</p>
                            ...
                            <table class="w-full border border-gray-800">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="border border-gray-800 p-1" rowspan="6">Tugas & Tanggung jawab
                                            Kerja</td>
                                        <td class="border border-gray-800 p-1">Serah terima pekerjaan (pekerjaan dalam
                                            proses,
                            ...
                            <p class="mb-4">Saya juga menyatakan bahwa saya tidak akan membocorkan rahasia DTI ITB
                                dan ITB. Saya
                                memahami bahwa jika saya tidak memenuhi salah satu dari hal-hal di atas, maka DTI ITB
                                maupun ITB
                                dapat
                                mengambil tindakan yang diperlukan, termasuk tindakan hukum sesuai dengan peraturan yang
                                berlaku.
                            </p>
                            ...
                            <div class="w-full max-w-4xl mx-auto">
                                ...
                                <table class="w-full border border-gray-800">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="border border-gray-800 p-2 text-center">NIP/Nopeg. _____________
                                            </td>
                                            <td class="border border-gray-800 p-2 text-center">NIP/Nopeg. _____________
                                            </td>
