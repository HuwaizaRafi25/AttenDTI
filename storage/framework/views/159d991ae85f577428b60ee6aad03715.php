                    ...
                    <div class="p-6 sm:p-8">
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex items-start space-x-4">
                                <img src="<?php echo e($announcement->user->profile_picture ? asset('storage/' . $announcement->user->profile_picture) : asset('assets/images/userPlaceHolder.png')); ?>"
                                    class="object-cover w-12 h-12 bg-gray-200 rounded-full ring-2 ring-gray-100"
                                    alt="User avatar">
                                <div>
                                    <div class="flex items-center space-x-2">
                                        <h3 class="text-lg font-semibold text-gray-900"><?php echo e($announcement->user->username); ?></h3>
                                        <span class="text-gray-400">•</span>
                                        <span class="text-sm text-gray-500"><?php echo e($announcement->user->role ?? 'User'); ?></span>
                                    </div>
                                    <p class="text-sm text-gray-500">
                                        <?php echo e($announcement->created_at->format('F j, Y, h:i A')); ?>

                                    </p>
                                </div>
                            </div>
                            <?php if(Auth::check() && (Auth::id() === $announcement->user_id || Auth::user()->role === 'admin')): ?>
                        ...
                        <div class="mt-6">
                            ...
                            <span
                                ...
                                <?php echo e($category->category_name ?? 'Uncategorized'); ?>

                            </span>
                            <h2 class="mt-4 text-2xl font-bold text-gray-900"><?php echo e($announcement->title); ?></h2>
                            <p class="mt-4 leading-relaxed text-gray-700"><?php echo nl2br(e($announcement->text)); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\dev\AttenDTI\AttenDTI\resources\views/menus/announcement_detail.blade.php ENDPATH**/ ?>