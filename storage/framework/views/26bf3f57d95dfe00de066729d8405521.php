...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" id="companyName" name="company_name"
                            ...
                            value="<?php echo e(old('company_name', $app_name ?? 'My Company')); ?>">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select id="lateTimeHour" name="late_time_hour"
                                    ...
                                    <?php for($i = 0; $i < 24; $i++): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e((old('late_time_hour', $late_time->hour ?? 8) == $i) ? 'selected' : ''); ?>>
                            ...
                            <div>
                                ...
                                <select id="lateTimeMinute" name="late_time_minute"
                                    ...
                                    <?php for($i = 0; $i < 60; $i += 5): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e((old('late_time_minute', $late_time->minute ?? 30) == $i) ? 'selected' : ''); ?>>
                                            <?php echo e(str_pad($i, 2, '0', STR_PAD_LEFT)); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="email" id="email" name="email"
                            class="mt-2 p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                            value="<?php echo e(old('email', $company->email ?? 'dti@itb.ac.id')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\dev\AttenDTI\AttenDTI\resources\views/menus/settings.blade.php ENDPATH**/ ?>