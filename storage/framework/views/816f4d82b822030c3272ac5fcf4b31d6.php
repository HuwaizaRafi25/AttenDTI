...
<head>
    ...
    <style>
        body {
            background-image: url('<?php echo e(asset('assets/images/small_login_pic.jpg')); ?>');
...
<body class="min-h-screen lg:bg-gray-50 flex flex-col lg:flex-row p-[3vh]">
    ...
    <img src="<?php echo e(asset('svg/pattern.svg')); ?>" class="lg:absolute hidden drop-shadow-lg lg:flex -bottom-10 left-0"
        alt="">
    <img src="<?php echo e(asset('svg/pattern2.svg')); ?>"
        class="lg:absolute hidden opacity-50 drop-shadow-lg lg:flex top-0 right-0 rotate-90" alt="">
    <img src="<?php echo e(asset('svg/pattern3.svg')); ?>"
    ...
    <div
        ...
        <div
            ...
            <img src="<?php echo e(asset('assets/images/logo_itb_512.png')); ?>" class="w-14 h-14" alt="ITB Logo">
        ...
        <div class="w-full max-w-md mx-auto">
            <div
                ...
                <img src="<?php echo e(asset('assets/images/icons/dti_icon.png')); ?>" class="w-24 h-24 lg:w-16 lg:h-16" alt="ITB Logo">
                <span class="mt-3 flex text-2xl font-bold sm:text-3xl lg:text-2xl">
                    <span class="text-[#9c9e9d]">
                        Atten
                    </span>
        ...
        <div class="relative lg:w-1/2 w-auto h-[94vh] inset-0 flex items-center justify-center lg:flex">
            <div class="relative">
                ...
                <img src="<?php echo e(asset('svg/login_pic.svg')); ?>"
            ...
            <div class="shadow-sm flex flex-col justify-center h-[94vh] lg:hidden max-w-2xl transition-smooth">
                <img src="<?php echo e(asset('svg/top_shape.svg')); ?>" class="min-w-[360px]">
                <div class="bg-white h-[60vh] min-w-[360px] relative overflow-hidden">
                    <img src="<?php echo e(asset('svg/pattern3.svg')); ?>"
                        ...
                        alt="">
                    <img src="<?php echo e(asset('svg/pattern.svg')); ?>"
                        ...
                        alt="">
                    <img src="<?php echo e(asset('svg/pattern4.svg')); ?>"
                ...
                <img src="<?php echo e(asset('svg/bottom_shape.svg')); ?>" class="min-w-[360px]">
            </div>
        </div>
    </div>
    <script src="<?php echo e(asset('assets/js/togglePassword.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/modalSuccess.js')); ?>"></script>
</body>
</html>

<?php /**PATH C:\dev\attenDTI_FIX\AttenDTI\AttenDTI\resources\views/auth/loginLayout.blade.php ENDPATH**/ ?>