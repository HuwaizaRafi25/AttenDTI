<?php $__env->startSection('content'); ?>
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="p-4 mt-4 bg-white rounded-lg sm:p-6">
            ...
            <div id="modal" class="fixed inset-0 bg-gray-600 bg-opacity-50 z-[50] items-center justify-center hidden">
                <div class="bg-white rounded-lg shadow-xl p-8 w-full max-w-4xl mx-4 relative h-[90vh] flex flex-col">
                    ...
                    <div class="flex-grow overflow-y-auto">
                        <form id="jobPostingForm" method="POST" action="<?php echo e(route('jobs.store')); ?>"
            ...
            <div class="flex items-center mb-6">
                <form id="searchForm" action="<?php echo e(route('job.view')); ?>" method="GET" class="flex-grow mb-6 mr-2"
            ...
            <div class="flex flex-col gap-6 lg:flex-row">
                <div class="flex-shrink-0 w-full lg:w-64">
                    ...
                    <div id="jobTypeDropdown" class="hidden space-y-3 transition-all duration-200 md:block">
                        <div class="flex items-center justify-between space-x-2">
                            ...
                            <a href="<?php echo e(route('job.view')); ?>" class="text-sm text-blue-500 lg:block">Clear all</a>
                        </div>
                        <div class="space-y-2">
                            <?php $__currentLoopData = $jobTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label
                                    ...
                                    <input type="checkbox" name="jobType[]" value="<?php echo e($jobType); ?>"
                                        <?php echo e(in_array($jobType, (array) request('jobType', [])) ? 'checked' : ''); ?>

                                        class="text-blue-500 rounded filter-checkbox">
                                    <div class="flex justify-between w-full space-x-4 cursor-pointer">
                                        <span><?php echo e($jobType); ?></span>
                                        <span><?php echo e($jobTypeCounts[$jobType] ?? 0); ?></span>
                                    </div>
                                </label>
                        ...
                        <?php $__currentLoopData = $jobLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobLevel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label
                                class="flex items-center px-3 mb-1 space-x-2 transition duration-200 rounded-md hover:bg-gray-100">
                                <input type="checkbox" name="experienceLevel[]" value="<?php echo e($jobLevel); ?>"
                                    <?php echo e(in_array($jobLevel, (array) request('experienceLevel', [])) ? 'checked' : ''); ?>

                                    class="text-blue-500 rounded filter-checkbox">
                                <div class="flex justify-between w-full space-x-4">
                                    <span><?php echo e($jobLevel); ?></span>
                                    <span><?php echo e($jobTypeCounts[$jobLevel] ?? 0); ?></span>
                                </div>
                            </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                            ...
                            <div class="p-4 transition-shadow border rounded-lg hover:shadow-lg job-card"
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <div
                                            ...
                                            <span class="font-bold text-blue-600">
                                                <?php echo e(strtoupper(substr($job->companies->company_name, 0, 1))); ?>

                                            </span>
                                        </div>
                                        <div>
                                            <h3 class="font-semibold"><?php echo e($job->job_title); ?></h3>
                                            <p class="text-sm text-gray-600"><?php echo e($job->companies->company_name); ?></p>
                                        </div>
                                    </div>
                                    <div class="absolute top-4 right-4 pin-job cursor-pointer <?php echo e($job->pinnedUsers->contains(auth()->id()) ? 'text-red-500' : 'text-gray-400 hover:text-gray-600'); ?>"
                                        data-job-id="<?php echo e($job->id); ?>">
                                        <i
                                            class="<?php echo e($job->pinnedUsers->contains(auth()->id()) ? 'fa-solid' : 'fa-regular'); ?> fa-heart"></i>
                                    </div>
                                </div>
                                <div class="flex flex-wrap gap-2 mt-3">
                                    <?php $__currentLoopData = explode(',', $job->job_type); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="flex items-center justify-between mt-4">
                                    <span class="font-semibold">
                                        Rp <?php echo e(number_format($job->salary, 0, ',', '.')); ?>/month
                                    </span>
                                    <span class="text-sm text-gray-500">
                                        Closing on <?php echo e($job->end_date); ?>
                ...
                <div id="pinnedjobs" class="grid flex-1 hidden grid-cols-1 gap-4 sm:grid-cols-2">
                    <?php $__empty_1 = true; $__currentLoopData = auth()->user()->pinned; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="relative">
                            <div class="p-4 transition-shadow border rounded-lg hover:shadow-lg job-card"
                                data-job-id="<?php echo e($job->id); ?>">
                                <div class="flex items-start justify-between">
                    ...
                    <?php if($jobs->hasPages()): ?>
                        <nav role="navigation" aria-label="<?php echo e(__('Pagination Navigation')); ?>">
                            <span class="relative z-0 inline-flex rounded-md shadow-sm rtl:flex-row-reverse">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($jobs->previousPageUrl()); ?>" rel="prev"
                                ...
                                <?php $__currentLoopData = $jobs->links()->elements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(is_string($element)): ?>
                                        <span aria-disabled="true">
                                            <span
                                                class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-gray-700 bg-white border border-gray-300 cursor-default"><?php echo e($element); ?></span>
                                        </span>
                                    <?php endif; ?>

                                    <?php if(is_array($element)): ?>
                                        <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($page == $jobs->currentPage()): ?>
                                                <span aria-current="page">
                                                    <span
                                                        class="relative inline-flex items-center px-4 py-2 -ml-px text-base font-medium leading-5 bg-gray-200 border border-gray-300 cursor-default"><?php echo e($page); ?></span>
                                                </span>
                                            <?php else: ?>
                                ...
                                <?php if($jobs->hasMorePages()): ?>
                                    <a href="<?php echo e($jobs->nextPageUrl()); ?>" rel="next"
    ...
    <!-- Scripts -->
    <script src="<?php echo e(asset('assets/js/jobs.js')); ?>"></script>
    <script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\attenDTI_FIX\AttenDTI\AttenDTI\resources\views/menus/job.blade.php ENDPATH**/ ?>