...
<div id="absentModal" class="fixed inset-0 items-center justify-center bg-black/50 backdrop-blur-sm z-50 hidden">
    <div class="bg-white rounded-xl shadow-lg p-6 m-4 max-w-md w-full animate-fade-in">
        ...
        <form id="absentForm" action="<?php echo e(route('attendance.absent')); ?>" method="POST" class="space-y-5">
            <?php echo csrf_field(); ?>
            <div class="space-y-4">
...
<?php /**PATH D:\dev\AttenDTI\AttenDTI\resources\views/menus/modals/attendance/absent_attendance_modal.blade.php ENDPATH**/ ?>