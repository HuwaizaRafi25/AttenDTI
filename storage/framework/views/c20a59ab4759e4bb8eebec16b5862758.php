<?php $__env->startSection('content'); ?>
                ...
                <div class="w-full opacity-100 translate-x-0 transition-all duration-500 ease-in-out transform"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-4"
                            ...
                            <?php else: ?>
                                <?php $__currentLoopData = $todoTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="w-full h-max shadow-md bg-white rounded-md mt-2 relative p-4 task-card"
                                        id="task-<?php echo e($task->id); ?>" data-status="todo">
                                        <div class="absolute top-4 right-4 dropdown">
                                            ...
                                            <div
                                                ...
                                                <button
                                                    ...
                                                    data-task-id="<?php echo e($task->id); ?>" data-title="<?php echo e($task->title); ?>"
                                                    data-priority="<?php echo e($task->priority); ?>"
                                                    data-start-date="<?php echo e($task->start_date ? \Carbon\Carbon::parse($task->start_date)->format('Y-m-d') : ''); ?>"
                                                    data-due-date="<?php echo e($task->due_date ? \Carbon\Carbon::parse($task->due_date)->format('Y-m-d') : ''); ?>"
                                        ...
                                        <div class="flex items-center justify-between text-gray-500 text-xs">
                                            <div class="flex gap-x-3 items-center">
                                                <button onclick="changeTaskStatus(<?php echo e($task->id); ?>, 'in_progress')"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <span><?php echo e(\Carbon\Carbon::parse($task->due_date)->format('d M, Y')); ?></span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="flex flex-col items-start" id="inProgressColumn">
                            ...
                            <?php if($inProgressTasks->isEmpty()): ?>
                                <div
                                    class="w-full h-max rounded-md mt-2 relative p-4 text-gray-500">
                                    No Task Available
                                </div>
                            <?php else: ?>
                                <?php $__currentLoopData = $inProgressTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="w-full h-max shadow-md bg-white rounded-md mt-2 relative p-4 task-card"
                                        id="task-<?php echo e($task->id); ?>" data-status="in_progress">
                                        <div class="absolute top-4 right-4 dropdown">
                                            <button
                                                class="dropdown-toggle text-gray-400 hover:text-gray-600 focus:outline-none">
                                                <i class="fas fa-ellipsis-v"></i>
                                        ...
                                        <div class="flex items-center justify-between text-gray-500 text-xs">
                                            <div class="flex gap-x-3 items-center">
                                                <button onclick="changeTaskStatus(<?php echo e($task->id); ?>, 'completed')"
                                                    class="h-max w-max p-2 bg-blue-500 rounded-md text-white">
                                                    Mark Completed
                                                </button>
                                            </div>
                        ...
                        <div class="flex flex-col items-start" id="completedColumn">
                            <div class="flex items-center w-full mb-2">
                                ...
                                <div class="w-5 h-5 bg-gray-200 flex items-center justify-center rounded text-xs">
                                    <?php echo e($completedTasks->count()); ?>
                            ...
                            <?php else: ?>
                                <?php $__currentLoopData = $completedTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="w-full h-max shadow-md bg-white rounded-md mt-2 relative p-4 task-card"
                                        id="task-<?php echo e($task->id); ?>" data-status="completed">
                                        <div class="absolute top-4 right-4 dropdown">
                                            <button
                                                class="dropdown-toggle text-gray-400 hover:text-gray-600 focus:outline-none">
                                                <i class="fas fa-ellipsis-v"></i>
                        ...
                        <div class="flex flex-col items-start" id="backlogColumn">
                            <div class="flex items-center w-full mb-2">
                                ...
                                <div class="w-5 h-5 bg-gray-200 flex items-center justify-center rounded text-xs">
                                    <?php echo e($backlogTasks->count()); ?>

                                </div>
                            </div>
                            <?php if($backlogTasks->isEmpty()): ?>
                                <div
                                    class="w-full h-max rounded-md mt-2 relative p-4 text-gray-500">
                                    No Task Available
                                </div>
                            <?php else: ?>
                                <?php $__currentLoopData = $backlogTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="w-full h-max shadow-md bg-white rounded-md mt-2 relative p-4 task-card"
                                        id="task-<?php echo e($task->id); ?>" data-status="backlog">
                                        <div class="absolute top-4 right-4 dropdown">
                                            <button
                                                class="dropdown-toggle text-gray-400 hover:text-gray-600 focus:outline-none">
                                                <i class="fas fa-ellipsis-v"></i>
                            ...
                            <div class="space-y-4">
                                <div class="w-full overflow-x-auto">
                                    <div class="min-w-max space-y-4">
                                        <?php $__currentLoopData = ['To Do' => $todoTasks, 'In Progress' => $inProgressTasks, 'Completed' => $completedTasks, 'Backlog' => $backlogTasks]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section => $tasks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="border rounded-lg">
                                                <!-- Header Section -->
                                                <div class="flex items-center justify-between p-4 bg-gray-100 rounded-t-lg cursor-pointer"
                                                    id="<?php echo e(strtolower(str_replace(' ', '', $section))); ?>Dropdown">
                                                    <div class="flex items-center">
                                                        <i class="fas fa-chevron-down w-4 h-4 mr-2"></i>
                                                        <h3 class="font-medium"><?php echo e($section); ?></h3>
                                                        <span
                                                ...
                                                <!-- Task List -->
                                                <div id="<?php echo e(strtolower(str_replace(' ', '', $section))); ?>Tasks"
                                                    ...
                                                    <?php $__empty_1 = true; $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                        <div id="task-row-<?php echo e($task->id); ?>"
                                                            class="grid grid-cols-5 gap-4 py-4 px-4 items-center text-sm task-row"
                                                            data-status="<?php echo e(strtolower($section)); ?>"
                                                            data-task-id="<?php echo e($task->id); ?>">
                                                            ...
                                                            <div class="col-span-1 text-center truncate">
                                                                <?php echo e(\Carbon\Carbon::parse($task->start_date)->format('d M Y')); ?>
                                                            ...
                                                            <div class="col-span-1 text-center relative">
                                                                <div class="flex items-center justify-center space-x-2">
                                                                    <?php if(in_array(strtolower($section), ['backlog', 'to do', 'in progress'])): ?>
                                                                        <?php if(in_array(strtolower($section), ['backlog', 'to do'])): ?>
                                                                            <button
                                                                                onclick="changeTaskStatus(<?php echo e($task->id); ?>, 'in_progress')"
                                                                                title="Do The Task"
                                                                                class="p-2 bg-transparent rounded-md text-blue-500">
                                                                                <i class="fas fa-play"></i>
                                                                            </button>
                                                                        <?php elseif(strtolower($section) == 'in progress'): ?>
                                                                            <button
                                                                                onclick="changeTaskStatus(<?php echo e($task->id); ?>, 'completed')"
                            ...
                            <div class="max-w-6xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
                                        ...
                                        <div class="min-w-max">
                                            <div class="mb-8">
                                                ...
                                                <div class="flex mb-4 sticky top-0 bg-white"
                                                    style="width: <?php echo e($timelineWidth); ?>px;">
                                                    <?php for($i = 0; $i < $totalDays; $i++): ?>
                                                        <div class="text-center" style="width: <?php echo e($dayWidth); ?>px;">
                                                            <div class="text-sm font-medium text-gray-600 mb-1">
                                                                <?php echo e($start->copy()->addDays($i)->format('M d')); ?>
                                            ...
                                            <div class="space-y-6" id="timelineContent">
                                                ...
                                                ?>
                                                <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionName => $tasks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="mb-8">
                                                        <h3 class="text-lg font-bold mb-4 sticky left-0 bg-white">
                                                            <?php echo e($sectionName); ?></h3>
                                                        <div class="space-y-4"
                                                            id="timeline-<?php echo e(strtolower(str_replace(' ', '', $sectionName))); ?>">
                                                            <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="flex min-w-max task-timeline"
                                                                    ...
                                                                    ?>
                                                                    <div class="h-14 bg-<?php echo e($colors[$sectionName]); ?>-100 text-<?php echo e($colors[$sectionName]); ?>-800 rounded-lg relative transition-all duration-300 ease-in-out hover:shadow-md"
                                                                        style="width: <?php echo e($width); ?>px; margin-left: <?php echo e($leftOffset); ?>px;">
                                                                        <div class="absolute inset-0 flex items-center">
                                                                            <span
                                                                                class="text-sm font-medium truncate ml-4"><?php echo e($task->title); ?></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="bg-gray-50 px-6 py-4 flex justify-between items-center sticky bottom-0">
                                    <div class="flex items-center text-sm text-gray-600">
                                        Project duration: <?php echo e($start->format('M d')); ?> - <?php echo e($end->format('M d')); ?>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function updateTimeline(task) {
                ...
                const start = new Date(
                    "<?php echo e($minStartDate ? $minStartDate : \Carbon\Carbon::now()->toDateString()); ?>");
    ...
    <script src="<?php echo e(asset('assets/js/slide-animation.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/desc.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\dev\AttenDTI\AttenDTI\resources\views/menus/task.blade.php ENDPATH**/ ?>