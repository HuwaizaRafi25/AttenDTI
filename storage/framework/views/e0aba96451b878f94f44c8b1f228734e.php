            ...
            <div class="flex w-full gap-x-4 items-stretch">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 w-2/3 h-auto">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li class="flex items-start space-x-3 py-2 border-b border-gray-100">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <span class="text-xs text-gray-500"><?php echo e($activity->created_at->format('H:i A')); ?></span>
                                    </div>
                                </li>
                    ...
                    <div class="mt-4 text-right">
                        <a href="<?php echo e(route('activityLogs.index')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors">
                            View All Activities
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 w-1/2 h-auto">
                    ...
                    <div class="mt-6">
                        <div class="w-full bg-gray-200 rounded-full h-2.5">
                            ...
                            ?>
                            <div class="bg-green-600 h-2.5 rounded-full" style="width: <?php echo e($activePercentage); ?>%"></div>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 w-1/2 h-auto">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="bg-blue-50 p-4 rounded-xl">
                            ...
                            <p class="text-2xl font-bold text-gray-800">Rp <?php echo e(number_format($totalDuesThisMonth, 0, ',', '.')); ?></p>
                        ...
                        <div class="bg-red-50 p-4 rounded-xl">
                            ...
                            <p class="text-2xl font-bold text-gray-800"><?php echo e($unpaidStudents); ?></p>
            ...
            <div class="flex w-full gap-x-4 items-stretch">
                <div class="bg-white rounded-2xl shadow-lg p-6 w-full h-auto">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="<?php echo e(route('job.view')); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">View All</a>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\attenDTI_FIX\AttenDTI\AttenDTI\resources\views/menus/overview.blade.php ENDPATH**/ ?>