    ...
    <div class="max-w-md bg-white shadow-xl rounded-xl min-w-80 max-h-[80vh] overflow-y-auto">
        <div id="gradientGenderColor" class="w-full rounded-t-lg bg-gradient-to-tr from-blue-600 to-blue-300 h-28">
            <div class="flex items-center justify-end p-4">
                <img id="closeViewcashModal" src="<?php echo e(asset('assets/images/icons/xmark.svg')); ?>"
            ...
            <div class="flex flex-col items-left mb-6 -mt-[73px]">
                ...
                <div class="flex items-center">
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" id="userPlacement"
                        ...
                        <img src="<?php echo e(asset('assets/images/icons/building.svg')); ?>" alt="placementIcon"
...
<?php /**PATH C:\dev\attenDTI_FIX\AttenDTI\AttenDTI\resources\views/menus/modals/dues/view_dues_modal.blade.php ENDPATH**/ ?>