                ...
                <div id="user-table" class="w-full overflow-x-scroll">
                    <table class="min-w-full w-full table-auto" id="userTable">
                        ...
                        <tbody id="content" class="text-gray-600 text-sm font-light">
                            <?php echo $__env->make('menus.tables.user_table', ['users' => $users], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </tbody>
                    </table>
                </div>
                                ...
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="border border-gray-300 text-wrap flex-wrap p-2">
                                            <?php echo e($user->identity_number ? $user->identity_number : '-'); ?>

                                        </td>
                                        <td class="border border-gray-300 text-wrap p-2"><?php echo e($user->full_name); ?>

                                        </td>
                                        <td class="border border-gray-300 text-wrap flex-wrap p-2"><?php echo e($user->itb_account); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\attenDTI_FIX\AttenDTI\AttenDTI\resources\views/menus/user.blade.php ENDPATH**/ ?>