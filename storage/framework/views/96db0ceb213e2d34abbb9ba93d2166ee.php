<?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <body
        ...
        <a href="<?php echo e(route('overview')); ?>" class="fixed z-10 text-black top-5 left-5 ">
        ...
        <div class="relative w-full max-w-xl overflow-visible text-black profile-card">
            ...
            <div class="px-6 pb-6 -mt-24">
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <div class="flex justify-between w-full mb-4">
                        ...
                        <div class="flex items-end gap-4 transition-all duration-500 transform">
                            <?php if(Auth::check() && Auth::user()->username === $user->username): ?>
                                <a href="<?php echo e(url('addface')); ?>"
                                    class="text-gray-600 transition-all hover:text-gray-800 hover:scale-125">
                                    <img src="<?php echo e(asset('assets/images/icons/face.svg')); ?>" class="w-6 h-6 opacity-85"
                                        alt="">
                                </a>
                                <a href="<?php echo e(route('users.updateView', ['id' => $user->id])); ?>"
                                    class="text-gray-600 transition-all hover:text-gray-800 hover:scale-125">
                                ...
                                <div class="relative" x-data="{ isOpen: false }">
                                    ...
                                    <div x-show="isOpen"
                                        ...
                                        <div class="py-1">
                                            ...
                                            <a href="<?php echo e(route('print.sertifikat_penilaian')); ?>"
                                                class="block px-4 py-2 text-sm text-gray-700 cursor-pointer hover:bg-gray-100">
                                                Sertifikat Penilaian
                                            </a>
                                            <a href="<?php echo e(route('print.sertifikat_kompetensi')); ?>"
                                                class="block px-4 py-2 text-sm text-gray-700 cursor-pointer hover:bg-gray-100">
                    ...
                    <h1 class="text-xl font-semibold"><?php echo e($user->full_name); ?> |
                        <?php echo e($user->placement ? $user->placement->name : 'N/A'); ?></h1>
                    <p class="mt-1 text-sm text-gray-600"><?php echo e($user->username); ?> •
                ...
                <div class="">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <p class="text-sm font-medium"><?php echo e($user->itb_account ?? 'N/A'); ?></p>
                        </div>
                        <div>
                            <p class="mb-1 text-xs text-gray-500">Email</p>
                            <p class="text-sm font-medium"><?php echo e($user->email ? $user->email : 'N/A'); ?></p>
                        </div>
                        <div>
                            <p class="mb-1 text-xs text-gray-500">Identity Number</p>
                            <p class="text-sm font-medium">
                                <?php echo e($user->identity_number ? $user->identity_number : 'N/A'); ?></p>
                        </div>
                        <div>
                            <p class="mb-1 text-xs text-gray-500">Phone</p>
                            <p class="text-sm font-medium"><?php echo e($user->phone ?: 'N/A'); ?></p>
                        </div>
                        <div class="col-span-2">
                            <p class="mb-1 text-xs text-gray-500">Address</p>
                            <p class="text-sm font-medium"><?php echo e($user->address ?: 'N/A'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="text-sm font-medium"><?php echo e($user->period_start_date ?? 'N/A'); ?></p>
                        </div>
                        <div>
                            <p class="mb-1 text-xs text-gray-500">End Date</p>
                            <p class="text-sm font-medium"><?php echo e($user->period_end_date ?? 'N/A'); ?></p>
                        </div>
                        <div>
                            <p class="mb-1 text-xs text-gray-500">Major</p>
                            <p class="text-sm font-medium"><?php echo e($user->major ?? 'N/A'); ?></p>
                        </div>
                        <div>
                            <p class="mb-1 text-xs text-gray-500">Institution</p>
                            <p class="text-sm font-medium"><?php echo e($user->institution ?: 'N/A'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="w-full border border-gray-800 table-fixed opacity-70">
                            <tr>
                                <td class="w-1/6 p-2 text-center border-r border-gray-800">
                                    <img src="<?php echo e(asset('assets/images/logo_itb_512.png')); ?>" alt="Logo"
                            ...
                            <div class="mt-2 text-sm">
                                ...
                                <table class="w-full mb-4">
                                    <tr>
                                        ...
                                        <td>: <?php echo e(Auth::user()->full_name ?: '-'); ?></td>
                                    </tr>
                                    <tr>
                                        <td>No. Identitas</td>
                                        <td>: <?php echo e(Auth::user()->nisn ?: '-'); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Alamat</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>: <?php echo e(Auth::user()->institution ?: '-'); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Keperluan</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>: <?php echo e(Auth::user()->period_start_date); ?> s.d.
                                            <?php echo e(Auth::user()->period_end_date); ?></td>
                                    </tr>
                                </table>
            ...
            <div class="bg-gray-100 text-black rounded-lg shadow-lg m-6 p-6 h-[95vh] max-w-6xl w-full">
                <div class="overflow-y-auto h-[80vh] space-y-4">
                    <div id="certificateContent" class="certificate-container print-bg"
                        style="background-image: url('<?php echo e(asset('assets/images/template-sertifikat.png')); ?>');">
                        ...
                        <div class="certificate-content">
                            ...
                            <div class="certificate-body">
                                ...
                                <h2 class="certificate-name"><?php echo e($user->full_name); ?></h2>
                                <div class="space-y-2 text-xl text-blue-800">
                                    ...
                                    <p>dari tanggal <?php echo e(\Carbon\Carbon::parse($user->period_start_date)->format('d F Y')); ?> - <?php echo e(\Carbon\Carbon::parse($user->period_end_date)->format('d F Y')); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="certificate-footer">
                                <div class="flex flex-col items-center">
                                    <img src="<?php echo e(asset('assets/images/ttd.png')); ?>"
        ...
        <script>
            ...
            const username = '<?php echo e($user->full_name); ?>'.replace(/\s+/g, '_');
            ...
            function preloadImages() {
                const images = [
                    '<?php echo e(asset('assets/images/template-sertifikat.png')); ?>',
                    '<?php echo e(asset('assets/images/ttd.png-removebg-preview.png')); ?>'
                ];
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH D:\dev\AttenDTI\AttenDTI\resources\views/profile.blade.php ENDPATH**/ ?>