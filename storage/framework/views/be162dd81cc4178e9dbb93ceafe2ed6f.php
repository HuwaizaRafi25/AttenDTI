<?php $__env->startSection('content'); ?>
    <div class="lg:flex lg:flex-row gap-6 <?php echo e(Auth::user()->hasRole('admin') ? 'px-6' : 'p-6'); ?>  min-h-screen">
                        ...
                        <div class="w-full justify-between flex flex-col h-full">
                            <div class="flex w-full justify-between items-center">
                                ...
                                <div class="flex justify-between items-center gap-2">
                                    <button id="prevMonth"
                                        class="text-white hover:text-gray-300 p-1 rounded-full hover:bg-blue-800">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li class="flex items-start space-x-3 py-2 border-b border-gray-100">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <span
                                                class="text-xs text-gray-500"><?php echo e($activity->created_at->format('H:i A')); ?></span>
                                        </div>
                                    </li>
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-5 h-1/2 border-l-4 border-green-500">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-gray-800"><?php echo e($present); ?></p>
                                    <p class="text-xs text-gray-500 mt-1">
                                        <?php if(isset($presentPercentage)): ?>
                                            <span class="text-green-500"><?php echo e($presentPercentage); ?>%</span> of total students
                                        <?php else: ?>
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-5 h-1/2 border-l-4 border-red-500">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-gray-800"><?php echo e($absent); ?></p>
                                    <p class="text-xs text-gray-500 mt-1">
                                        <?php if(isset($absentPercentage)): ?>
                                            <span class="text-red-500"><?php echo e($absentPercentage); ?>%</span> of total students
                                        <?php else: ?>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 w-1/2 h-auto">
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div class="bg-blue-50 p-4 rounded-xl">
                                ...
                                <p class="text-2xl font-bold text-gray-800"><?php echo e($totalStudents); ?></p>
                            ...
                            <div class="bg-green-50 p-4 rounded-xl">
                                ...
                                <p class="text-2xl font-bold text-gray-800"><?php echo e($activeStudents); ?></p>
                            ...
                            <div class="bg-red-50 p-4 rounded-xl">
                                ...
                                <p class="text-2xl font-bold text-gray-800"><?php echo e($inactiveStudents); ?></p>
                        ...
                        <div class="mt-6">
                            <div class="w-full bg-gray-200 rounded-full h-2.5">
                                ...
                                ?>
                                <div class="bg-green-600 h-2.5 rounded-full" style="width: <?php echo e($activePercentage); ?>%">
                                </div>
                            </div>
                            <div class="flex justify-between mt-2 text-xs text-gray-500">
                                <span><?php echo e(number_format($activePercentage, 1)); ?>% Active</span>
                                <span><?php echo e(number_format(100 - $activePercentage, 1)); ?>% Inactive</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-blue-50 p-4 rounded-xl">
                                ...
                                <p class="text-2xl font-bold text-gray-800">Rp
                                    <?php echo e(number_format($totalDuesThisMonth, 0, ',', '.')); ?></p>
                            ...
                            <div class="bg-red-50 p-4 rounded-xl">
                                ...
                                <p class="text-2xl font-bold text-gray-800"><?php echo e($unpaidMonths); ?></p>
                                <p class="text-xs text-gray-500 mt-1">Months with unpaid dues</p>
                            </div>
                        </div>
                        <div class="mt-6">
                            <?php
                                $paidMonths = $totalStudents - $unpaidMonths;
                                $paidPercentage = $totalStudents > 0 ? ($paidMonths / $totalStudents) * 100 : 0;
                            ?>
                            <div class="w-full bg-gray-200 rounded-full h-2.5">
                                <div class="bg-blue-600 h-2.5 rounded-full" style="width: <?php echo e($paidPercentage); ?>%"></div>
                            </div>
                            <div class="flex justify-between mt-2 text-xs text-gray-500">
                                <span><?php echo e(number_format($paidPercentage, 1)); ?>% Paid</span>
                                <span><?php echo e(number_format(100 - $paidPercentage, 1)); ?>% Unpaid</span>
                            </div>
                        </div>
                ...
                <div class="flex w-full gap-x-4 items-stretch">
                    <div class="bg-white rounded-2xl shadow-lg p-6 w-full h-auto">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <a href="<?php echo e(route('job.view')); ?>"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="bg-gray-50 p-4 rounded-xl">
                                ...
                                <p class="text-3xl font-bold text-gray-800"><?php echo e($jobVacancies); ?></p>
                                ...
                                <div class="space-y-3 overflow-y-auto max-h-40 pr-2">
                                    <?php $__empty_1 = true; $__currentLoopData = $latestJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="bg-gray-50 p-3 rounded-lg border-l-4 border-blue-500">
                                            <h5 class="font-medium text-gray-800"><?php echo e($job->title); ?></h5>
                                            <div class="flex justify-between items-center mt-2">
                                                <span class="text-xs text-gray-500"><?php echo e($job->company); ?></span>
                                                <a href="" class="text-xs text-blue-600 hover:text-blue-800">View
                                                    Details</a>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        .then(data => {
                            ...
                            document.getElementById('chartPeriod').addEventListener('change', function() {
                                ...
                                fetch(`/attendance/chart-data?period=${period}`)
                                    .then(response => response.json())
                                    .then(newData => {
                                        attendanceChart.data.datasets[0].data = [newData.present, newData
                                            .absent
                                        ];
        ...
        <?php else: ?>
            <div class="bg-white lg:w-3/4 md:w-full rounded-lg shadow-lg p-6 mb-6 lg:mb-0">
                ...
                <p class="text-3xl font-semibold text-blue-800 mb-6"><?php echo e(Auth::user()->username); ?>!</p>
                ...
                <?php if($isHoliday || $isWeekend): ?>
                    <div class="bg-yellow-100 border-l-4 border-yellow-500 p-4 mb-8">
                        <p class="text-yellow-700">Hari ini adalah hari libur. Tidak ada kegiatan presensi.</p>
                    </div>
                <?php else: ?>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                        <div
                            ...
                            <p class="text-xl font-semibold text-blue-900">
                                <?php echo e(Auth::User()->attendances()->where('check_in', '!=', null)->first()->check_in->format('H:i') ?? 'Belum Absen'); ?>
                        ...
                        <div
                            ...
                            <p class="text-xl font-semibold text-blue-900">16:00</p>
                        </div>
                        <div
                            ...
                            <p class="text-xl font-semibold text-blue-900">
                                <?php echo e(Auth::User()->attendances()->where('check_in', '!=', null)->count()); ?> Hari</p>
                        </div>
                    </div>
                <?php endif; ?>
                <div>
                    <h3 class="text-xl font-semibold text-blue-800 mb-4">History</h3>
                    <?php $__currentLoopData = Auth::User()->attendances()->where('check_in', '!=', null)->orderBy('created_at', 'desc')->limit(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-gradient-to-r from-green-100 to-blue-100 rounded-lg p-4 mb-4">
                            <div class="flex flex-wrap items-center justify-between">
                                <div
                                    class="w-16 h-16 bg-blue-200 rounded-full flex items-center justify-center mb-2 md:mb-0">
                                    <p class="text-sm font-semibold text-blue-600">
                                        <?php echo e($attendance->check_in->format('d M')); ?></p>
                                </div>
                                <div class="flex flex-col items-center mb-2 md:mb-0">
                                    <p class="text-sm text-blue-600">Masuk</p>
                                    <p class="font-semibold text-blue-800"><?php echo e($attendance->check_in->format('H:i')); ?></p>
                                </div>
                                <div class="flex flex-col items-center mb-2 md:mb-0">
                                    <p class="text-sm text-blue-600">Keluar</p>
                                    <p class="font-semibold text-blue-800">16:00</p>
                                </div>
                                <div class="flex flex-col items-center mb-2 md:mb-0">
                                    <p class="text-sm text-blue-600">Jam Total</p>
                                    <p class="font-semibold text-blue-800">
                                        <?php echo e($attendance->check_in
                                            ? $attendance->check_in->diffInHours(
                                                $attendance->check_out ?? \Carbon\Carbon::parse($attendance->check_in->format('Y-m-d') . ' 16:00:00'),
                                            )
                                            : 0); ?>
                            ...
                            <div class="flex justify-center mt-2">
                                <div class="text-sm ml-12 text-blue-600"><?php echo e($attendance->location->name); ?></div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\dev\AttenDTI\AttenDTI\resources\views/menus/overview.blade.php ENDPATH**/ ?>