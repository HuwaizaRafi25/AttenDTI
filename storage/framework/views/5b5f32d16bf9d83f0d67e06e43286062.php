...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/radar.css')); ?>">
    <?php echo notifyCss(); ?>
    <style>
        /* Base styles */
        body {
...
<body class="font-sans min-h-screen flex items-center justify-center p-4">
            ...
            <div class="flex-1 p-6 md:p-8 flex flex-col">
                ...
                <div class="mt-4 flex-1 flex flex-col items-center justify-center" id="content">
                    ...
                    <div id="errorContainer" class="hidden flex-col items-center mt-8 error-container max-w-md mx-auto">
                        <img id="errorImage" src="<?php echo e(asset('assets/images/gps_error.png')); ?>" alt="Geofencing Gagal"
                    ...
                    <div class="completion-container flex-col items-center justify-center space-y-6 max-w-md mx-auto hidden"
                        ...
                        <div class="profile-container mt-4">
                            <img src="<?php echo e(asset('storage/profilePics/' . Auth::user()->profile_pic)); ?>"
                        ...
                        <div class="user-info-card text-center space-y-3">
                            <p class="text-xl font-bold text-gray-800"><?php echo e(Auth::user()->full_name); ?></p>
                            <div class="flex justify-center space-x-4 text-sm text-gray-600">
                                <span><i class="fas fa-id-badge mr-1 text-blue-500"></i> <?php echo e(Auth::id()); ?></span>
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div class="bg-blue-50 p-2 rounded-lg">
                                        ...
                                        <p class="text-sm font-medium text-gray-700">
                                            ...
                                            <span id="attendanceDate"><?php echo e(date('d M Y')); ?></span>
                                        </p>
                                    </div>
                                    <div class="bg-blue-50 p-2 rounded-lg">
                                        ...
                                        <p class="text-sm font-medium text-gray-700">
                                            ...
                                            <span id="attendanceTime"><?php echo e(date('H:i:s')); ?></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="<?php echo e(asset('assets/js/attendanceAct.js')); ?>"></script>
</body>

</html>
<?php /**PATH D:\dev\AttenDTI\AttenDTI\resources\views/menus/attendance_act.blade.php ENDPATH**/ ?>