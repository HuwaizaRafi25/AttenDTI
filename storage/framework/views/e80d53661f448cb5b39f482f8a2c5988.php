    ...
    <div class="bg-white rounded-xl shadow-xl max-w-md min-w-80">
        <div id="gradientGenderColor" class="bg-gradient-to-tr from-blue-600 to-blue-300 w-full h-28 rounded-t-lg">
            <div class="flex justify-end items-center p-4">
                <img id="closeViewUserModal" src="<?php echo e(asset('assets/images/icons/xmark.svg')); ?>"
            ...
            <div class="flex flex-col items-left
             mb-6 -mt-[73px]">
                ...
                <div class="flex items-center">
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" id="userPlacement"
                        class="text-gray-600 text-sm font-medium ml-2 flex items-center"><span
                            class="h-6 bg-gray-600 w-[2px] rounded-lg"></span><img
                            src="<?php echo e(asset('assets/images/icons/building.svg')); ?>" alt="placementIcon"
            ...
            <div class="space-y-4">
                <div class="flex items-center">
                    <span class="bx bx-menu text-red-400 mr-3 scale-110">
                        <img src="<?php echo e(asset('assets/images/logo_itb_512.png')); ?>" class="w-8" alt="">
                    </span>
                    <div>
                        ...
                        <a id="emailLink" href="" class="text-blue-600 hover:underline flex items-center">
                            ...
                            <span class="bx bx-menu toggle ml-0.5" style="scale: 0.6">
                                <?php echo file_get_contents(public_path('assets/images/icons/external.svg')); ?>
                ...
                <div id="majorContainer" class="flex items-center ml-1 gap-x-1">
                    <span class="bx bx-menu text-blue-400 mr-3 scale-110">
                        <img src="<?php echo e(asset('assets/images/icons/major.svg')); ?>" class="w-6 opacity-75"
                            alt="">
                    </span>
                    <div>
                ...
                <div class="flex items-center ml-1 gap-x-1">
                    <span class="bx bx-menu text-blue-400 mr-3 scale-110">
                        <img src="<?php echo e(asset('assets/images/icons/institution.svg')); ?>" class="w-6 opacity-75"
                            alt="">
                    </span>
                    <div>
...
<?php /**PATH C:\dev\attenDTI_FIX\AttenDTI\AttenDTI\resources\views/menus/modals/user/view_user_modal.blade.php ENDPATH**/ ?>