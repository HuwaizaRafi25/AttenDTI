<div id="linkUserPermission" class="fixed inset-0 bg-black bg-opacity-50 items-center justify-center p-4 z-50 hidden">
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full overflow-hidden">
        ...
        <form id="assignPermissionForm" action="<?php echo e(route('rolesPermissions.link')); ?>" class="p-4 space-y-4"
            method="POST">
            <?php echo csrf_field(); ?>
            <div class="space-y-2">
...
<?php /**PATH C:\dev\attenDTI_FIX\AttenDTI\AttenDTI\resources\views/menus/modals/rolePermission/link_user_modal.blade.php ENDPATH**/ ?>