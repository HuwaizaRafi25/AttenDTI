...
<div id="addModal" class="fixed inset-0 -left-96 items-center justify-center bg-black bg-opacity-50 z-50 hidden">
    <div class="bg-white rounded-lg shadow-lg p-6 m-6 max-w-2xl w-full">
        <div class="flex items-center pb-4 mb-4 justify-between">
            ...
            <img id="closeAddUserModal" src="<?php echo e(asset('assets/images/icons/xmark.svg')); ?>"
                class="w-4 h-4 opacity-65 font-extrabold cursor-pointer transition-all duration-150 hover:opacity-85"
                alt="closeIcon">
        </div>
        <form id="addUserForm" action="<?php echo e(route('users.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="md:flex items-center justify-center w-full gap-4">
                ...
                <div class="flex justify-center md:w-1/4">
                    ...
                    <label for="profileImageInput" class="relative cursor-pointer inline-block">
                        <img id="profileImage" src="<?php echo e(asset('assets/images/userPlaceHolder.png')); ?>" alt="User Profile"
...
unset($__errorArgs, $__bag); ?>">
            ...
            <div class="flex justify-end mt-6">
                <button type="submit"
                    ...
                    <img src="<?php echo e(asset('assets/images/icons/whitePlus.svg')); ?>" class="w-5 h-5 mr-2" alt="Add Icon">
                    <span>Add</span>
                </button>
            </div>
        </form>
...
<?php /**PATH C:\dev\attenDTI_FIX\AttenDTI\AttenDTI\resources\views/menus/modals/user/add_user_modal.blade.php ENDPATH**/ ?>